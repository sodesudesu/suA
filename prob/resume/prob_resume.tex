...
%\setmainfont{UDDigiKyokashoNP-R}[BoldFont=UDDigiKyokashoNP-B, YokoFeatures={JFM=jlreq}, TateFeatures={JFM=jlreq}]
%%%%%%
...
%実際にRというプログラミング言語でこのフィルタを実行してみたので興味のある人は見てあげてください。
}。
